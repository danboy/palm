 ...
 * 22/6/2008
 */
JSSpec.DSL.Subject.prototype.should_throw = function(expected) {
	try{
		this.target();
		this.target = null
	} catch(e){
  ...
  var exception = expected || this.target;
	this.should_be(exception);
};
 ...
 * 22/6/2008
 */
JSSpec.DSL.Subject.prototype.should_not_throw = function() {
	try{
		this.target();
		this.target = null
	} catch(e){
		this.target = e.message || e;
	}
	this.should_be(null);
};
